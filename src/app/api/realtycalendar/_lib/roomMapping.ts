export const REALTYCALENDAR_ROOM_TO_TRAVEL_ROOM: Record<string, string> = {
    ...
    // Барнаба (RC объект «Жоэкварская улица, 21», лот 362769): 15 номеров.
    // В RealtyCalendar они помечены подряд 01–15, а в отеле нумерация 1–16
    // БЕЗ шестого: №6 — техническая комната, там живут хозяева, она не
    // продаётся и в RealtyCalendar отсутствует. Поэтому RC 06 → наш «7 номер»
    // и далее со сдвигом на единицу.
    '149221': 'd256e652-680d-4485-a0a8-0d7649906b22', // RC 01 -> 1 номер 3х 1эт
    '149222': '81d49178-23ee-4ad1-8cce-b65a0babcbb5', // RC 02 -> 2 номер 3х 1эт
    '149223': '00de5c18-b291-45a4-8f8b-12bb144fde81', // RC 03 -> 3 номер 3х 1эт
    '149224': 'f5222112-d2e5-42cc-85f5-d4aa011ea339', // RC 04 -> 4 номер 2х 1эт
    '149225': '8aba614e-78d2-4d67-aa75-871b8b14c328', // RC 05 -> 5 номер 2х 1эт
    '149226': 'bfd13ab4-6501-4f34-991f-83394336f76b', // RC 06 -> 7 номер 2х 1эт (6-й пропущен)
    '149227': '328dedf3-fb0c-48c5-86b2-916850ece597', // RC 07 -> 8 номер 2х 1эт
    '149228': '9148a5f2-1409-4d63-a0fe-20232abf51dc', // RC 08 -> 9 номер 3х 2эт
    '149229': '7d756593-1a06-40d7-a1ea-2f5d4128cc86', // RC 09 -> 10 номер 3х 2эт
    '149230': '8844adf4-bb6f-455c-83c6-781abb147397', // RC 10 -> 11 номер 3х 2эт
    '149231': '52b88f23-2ce0-4289-b97e-4a6f67d2a96f', // RC 11 -> 12 номер 3х 2эт
    '149232': 'd09dae77-af27-41e8-a7b9-0af7b2c1f72b', // RC 12 -> 13 номер 3х 2эт
    '149233': '2456d4fd-0e90-4eb3-93b8-209ad5c9fb75', // RC 13 -> 14 номер 3х 2эт
    '149234': 'c0f59352-ac16-4d15-bc31-2a46ca0a2e46', // RC 14 -> 15 номер 2х 2эт
    '149235': '0a285e6a-9145-4a7e-b4ad-a846077a3573', // RC 15 -> 16 номер 2х 2эт
};
