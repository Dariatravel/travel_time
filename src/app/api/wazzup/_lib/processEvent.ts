 ...
 *
 * Пропуск по правилу (известный канал с транспортом не из
 * WAZZUP_ACCEPTED_TRANSPORTS, кривое тело) — не ошибка: событие получает
 * processed_at, причины видны в его поле error.
 *
 * Неизвестный канал — ОШИБКА, а не пропуск: событие остаётся неразобранным
 * и дождётся повторного разбора, когда в «Настройке» нажмут «Обновить
 * каналы». Иначе сообщения нового Instagram-канала пропали бы насовсем.
 *
